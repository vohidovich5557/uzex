    ...
    return (
        <>
         <div className="container pt-[50px] flex flex-col lg:items-center lg:justify-center gap-[40px] lg:gap-[60px] pb-[100px]">
            ...
            <div className="grid grid-cols-1 w-[100%] md:grid-cols-3 md:gap-[10px] md:justify-between items-center justify-center gap-[70px]">
            <div data-aos='fade-right' data-aos-duration='3000' className="flex flex-col relative items-center border shadow-lg bg-lightBlue rounded-[30px] py-[20px] lg:py-[20px] justify-center gap-[30px]">
                    <div className=' absolute w-[80px] h-[80px] translate-y-[-160px] lg:translate-y-[-150px] overflow-hidden rounded-[50%] border-4 border-whiteBg'>
                    ...
                    <div className='flex flex-col items-center justify-center mt-[40px] gap-[5px]'>
                        ...
                        <p className='text-rareGray w-[90%] mb-[20px] font-normal text-center'>Thanks to the creative approach, efficiency and responsibility of the Dynamic Soft team, 
                            our sales market for services has expanded significantly. We trust and value 
                            h Dynamic Soft for an individual approach to clients.</p>
