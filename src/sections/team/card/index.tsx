...
export const CardTeam = ({imgPath, id, name, position}: {imgPath: string, id: number, name: string, position: string}) => {
    return (
        <>
        <div key={id} data-aos='fade-right' data-aos-duration='3000' className="flex flex-col items-center border shadow-lg shadow-rareBlack border-rareBlack rounded-tr-[30px] py-[10px] rounded-bl-[30px] justify-center gap-[30px]">
