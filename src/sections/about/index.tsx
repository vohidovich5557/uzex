    ...
    return (
        <>
         <div className="container bg-whiteBg flex flex-col  pb-[20px] lg:pb-[100px] items-start lg:items-center gap-[30px] lg:gap-[50px] pt-[70px]"> 
            ...
            <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration='2000' className="w-[350px] lg:w-[330px] relative h-[400px] overflow-hidden border rounded-[30px]">
